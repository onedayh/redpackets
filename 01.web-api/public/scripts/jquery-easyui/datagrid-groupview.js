	...
	onBeforeRender: function(target, rows){
		...
		function initCss(){
			if (!$('#datagrid-group-style').length){
				//'.datagrid-group{height:'+opts.groupHeight+'px;
				$('head').append(
					'<style id="datagrid-group-style">' +
					'.datagrid-group{overflow:hidden;font-weight:bold;border-bottom:1px solid #ccc;white-space:nowrap;word-break:normal;}' +
